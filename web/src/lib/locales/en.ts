export default {
  ...
  'session.selection.activeDisabled': 'Active session cannot be selected',
  'session.selection.activeDisabledAria': '{name} is an active session and cannot be selected',
  'session.selection.toggleAria': 'Toggle selection for {name}',
  'session.selection.selectAll': 'Select All',
  'session.selection.deselectAll': 'Deselect All',
  'session.selection.selectedCount_one': '{n} session selected',
  'session.selection.selectedCount_other': '{n} sessions selected',
  'session.selection.selectAllAria': 'Select all selectable sessions',
  'session.selection.deselectAllAria': 'Deselect all sessions',
  'session.selection.selectGroupAria': 'Select all selectable sessions under {group}',
  'session.selection.deselectGroupAria': 'Deselect all selectable sessions under {group}',
  'session.selection.keyboardHint': 'Tip: Press Space to toggle selection, Esc to exit selection mode.',
  'session.selection.enterMode': 'Select',
  'session.selection.enterModeAria': 'Enter selection mode',
  'session.selection.exitMode': 'Exit select',
  'session.selection.exitModeAria': 'Exit selection mode',
  'session.bulkActions.delete': 'Delete',
  'session.bulkActions.cancel': 'Cancel',
  'session.bulkActions.deleteAria': 'Delete selected sessions',
  'session.bulkActions.cancelAria': 'Cancel selection',
  // bulkDelete: title_one title_other
  'session.bulkDelete.title_one': 'Delete {n} session?',
  'session.bulkDelete.title_other': 'Delete {n} sessions?',
  'session.bulkDelete.description_one': 'This action cannot be undone. Are you sure you want to delete this session?',
  'session.bulkDelete.description_other': 'This action cannot be undone. Are you sure you want to delete these sessions?',
  'session.bulkDelete.confirm': 'Delete',
  'session.bulkDelete.confirming': 'Deleting...',
  'session.bulkDelete.toastSuccessTitle': 'Deleted',
  'session.bulkDelete.toastSuccessBody_one': 'Deleted {n} session.',
  'session.bulkDelete.toastSuccessBody_other': 'Deleted {n} sessions.',
  'session.bulkDelete.toastPartialFailedTitle': 'Some deletions failed',
  'session.bulkDelete.toastPartialFailedBody_one': 'Failed to delete {n} session.',
  'session.bulkDelete.toastPartialFailedBody_other': 'Failed to delete {n} sessions.',
  'session.bulkDelete.toastAllFailedTitle': 'Delete failed',
  'session.bulkDelete.toastAllFailedBody_one': 'Failed to delete {n} session.',
  'session.bulkDelete.toastAllFailedBody_other': 'Failed to delete {n} sessions.',
