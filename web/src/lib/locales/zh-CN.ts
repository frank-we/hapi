export default {
  ...
  'session.selection.activeDisabled': '活跃会话无法选中',
  'session.selection.activeDisabledAria': '{name} 是活跃会话，无法选中',
  'session.selection.toggleAria': '切换选中 {name}',
  'session.selection.selectAll': '全选',
  'session.selection.deselectAll': '取消全选',
  'session.selection.selectedCount': '已选择 {n} 个会话',
  'session.selection.selectAllAria': '全选所有可选会话',
  'session.selection.deselectAllAria': '取消全选',
  'session.selection.selectGroupAria': '全选 {group} 下所有可选会话',
  'session.selection.deselectGroupAria': '取消全选 {group} 下所有可选会话',
  'session.selection.keyboardHint': '提示：按空格切换选中，按 Esc 退出选择模式',
  'session.selection.enterMode': '多选',
  'session.selection.enterModeAria': '进入多选模式',
  'session.selection.exitMode': '退出多选',
  'session.selection.exitModeAria': '退出多选模式',
  'session.bulkActions.delete': '删除',
  'session.bulkActions.cancel': '取消',
  'session.bulkActions.deleteAria': '删除选中的会话',
  'session.bulkActions.cancelAria': '取消选择',
  'session.bulkDelete.title': '删除 {n} 个会话？',
  'session.bulkDelete.description': '此操作无法撤销。确定要删除这些会话吗？',
  'session.bulkDelete.confirm': '删除',
  'session.bulkDelete.confirming': '删除中...',
  'session.bulkDelete.toastSuccessTitle': '删除成功',
  'session.bulkDelete.toastSuccessBody': '已删除 {n} 个会话',
  'session.bulkDelete.toastPartialFailedTitle': '部分删除失败',
  'session.bulkDelete.toastPartialFailedBody': '{n} 个会话删除失败',
  'session.bulkDelete.toastAllFailedTitle': '删除失败',
  'session.bulkDelete.toastAllFailedBody': '所选 {n} 个会话均删除失败',
